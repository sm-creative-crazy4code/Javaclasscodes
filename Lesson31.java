...
public static void main(String[] args) {
    ...
    System.out.println("Enter full month: ");
    ...
    public static void printMonth(int year, int month){
        printMonthTitles(year, month);
        printMonthBody(year, month);
    }
    
    public static void printMonthTitles(int year, int month){
  ...
  public static int getTotalNumberofDay(int year, int month){
    ...
    for(int i=1800;i<year;i++){
        if(isLeapYear(year)) total= total+366;
